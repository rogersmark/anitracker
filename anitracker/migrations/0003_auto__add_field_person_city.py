...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('anitracker_person', 'city', self.gf('django.db.models.fields.CharField')(default='chicago', max_length=128), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Person.city'
        db.delete_column('anitracker_person', 'city')
